...
class HostRepositorySpec extends ObjectBehavior
{
    ...
    public function it_should_return_all_hosts(
        HttpClient $client,
        Container $ioc,
        Host $host
    ) {
    ...
    public function it_finds_hosts_by_parameters(
        HttpClient $client,
        Container $ioc,
        Host $host
    ) {
        ...
        $ioc->make($this->fqnModel())->shouldBeCalled()->willReturn($host);
        $this->findBy(['HostName' => 'host'], true, self::$top, self::$skip, self::$orderby)
            ->shouldBeArray();
        $this->findBy(['HostName' => 'host'], true, self::$top, self::$skip, self::$orderby)
            ->shouldHaveCount(2);
        $this->findBy(['HostName' => 'host'], true, self::$top, self::$skip, self::$orderby)
    ...
    public function it_returns_empty_array_if_no_host_found_by_parameters(
        HttpClient $client,
        Container $ioc
    ) {
        $client->get('Hosts/Get', [
    ...
    public function it_throws_on_find_hosts_by_parameters_if_got_unexpected_response(HttpClient $client)
    {
        ...
        $this->shouldThrow('\Pisa\GizmoAPI\Exceptions\UnexpectedResponseException')
            ->duringFindBy(['HostName' => 'host'], true, self::$top, self::$skip, self::$orderby);
    }
    ...
    public function it_finds_one_host_by_parameters(
        HttpClient $client,
        Container $ioc,
        Host $host
    ) {
    ...
    public function it_returns_null_when_one_host_not_found(
        HttpClient $client,
        Container $ioc
    ) {
        $client->get('Hosts/Get', [
    ...
    public function it_throws_on_find_one_hosts_by_parameters_if_got_unexpected_response(HttpClient $client)
    {
        ...
        $this->shouldThrow('\Pisa\GizmoAPI\Exceptions\UnexpectedResponseException')
            ->duringFindOneBy(['HostName' => 'host'], true);
    }
    ...
    public function it_returns_null_on_get_host_when_host_not_found(
        HttpClient $client,
        Container $ioc,
        Host $host
    ) {
        ...
        $client->get('Hosts/Get/' . $id)
            ->shouldBeCalled()->willReturn(Helper::nullResponse());
    ...
    public function it_gets_host_by_number(
        HttpClient $client,
        Container $ioc,
        Host $host
    ) {
        $no = 1;
        $client->get('Hosts/GetByNumber', ['hostNumber' => $no])->shouldBeCalled()->willReturn(
    ...
    public function it_returns_empty_array_if_no_host_found_by_number(
        HttpClient $client,
        Container $ioc,
        Host $host
    ) {
        ...
        $client->get('Hosts/GetByNumber', ['hostNumber' => $no])
            ->shouldBeCalled()->willReturn(Helper::emptyArrayResponse());
    ...
    public function it_return_true_if_host_exists(
        HttpClient $client,
        Container $ioc,
        Host $host
    ) {
    ...
    public function it_returns_false_if_host_doesnt_exist(
        HttpClient $client,
        Container $ioc
    ) {
        $id = 1;
